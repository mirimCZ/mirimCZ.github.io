...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/BdxvomQ5sS)
...
```sh
npx nx serve stellaris-tech
```

To create a production bundle:

```sh
npx nx build stellaris-tech
```

To see all available targets to run for a project, run:

```sh
npx nx show project stellaris-tech
```
